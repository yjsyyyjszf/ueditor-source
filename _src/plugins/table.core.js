        ...
        getVSideCell: function(cell, bottom, ignoreRange) {
            try {
                ...
                if (
                    ...
                    (bottom && (!len ? cellInfo.rowIndex + cellInfo.rowSpan > this.rowsNum - 1 : range.endRowIndex == this.rowsNum - 1))
                )
                    return null;
        ...
        mergeRange: function() {
            ...
            if (leftTopCell.tagName == 'TH' && range.endRowIndex !== range.beginRowIndex) {
                ...
                range = this.getCellsRange(
                    leftTopCell,
                    this.getCell(index[this.rowsNum - 1][info.colIndex].rowIndex, index[this.rowsNum - 1][info.colIndex].cellIndex),
                );
            }
